...
**v2.7.0-rc2** — Last updated: 2026-05-31 12:55  *(no daily-flow changes; `/pr-fix` gained a pluggable native review engine + two-axis triage — see GUIDE.md; sync-method.sh example bumped to v2.7.0-rc2)*
...
```
1. ./scripts/sync-method.sh v2.7.0-rc2             (or latest tag)
