...
**v2.7.0-rc6** — Last updated: 2026-06-03 16:45  *(new `/pk-express` idea→Draft-PR autopilot for simple WITs (express lane over brainstorm→light-spec→branch→work, tier-guarded) + load-bearing `/light-spec` Spec-ready-state fix + `pipekit-cmux` turn-end watching lesson — see GUIDE.md / CHANGELOG; sync-method.sh example bumped to v2.7.0-rc6)*
...
```
1. ./scripts/sync-method.sh v2.7.0-rc6             (or latest tag)
