...
**v2.7.0-rc5** — Last updated: 2026-06-03 13:30  *(no daily-flow changes; `pk doctor` false-ship cross-check + completed `pk done` finish + four discipline lines — see GUIDE.md / CHANGELOG; sync-method.sh example bumped to v2.7.0-rc5)*
...
```
1. ./scripts/sync-method.sh v2.7.0-rc5             (or latest tag)
